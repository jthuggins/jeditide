...
import sidekick.SideKickBrowser;
 ...
 * @author     Martin Raspe
 * @created    Oct 13, 2010
 * @modified   $Id: SourceBrowser.java 16705 2010-10-13 15:21:38 jhuggins $
 * @version    $Revision: 16705 $
 ...
 * It replaces the SideKickBrowser dockable if desired.
 */
public class SourceBrowser extends SideKickBrowser {
    ...
    public SourceBrowser( View view, boolean docked ) {
        //{{{ SourceBrowser constructor
        super( view, docked );
    ...
    protected class Renderer extends DefaultTreeCellRenderer {
        //{{{ Renderer class
        // based on sidekick/SideKickBrowser.java
