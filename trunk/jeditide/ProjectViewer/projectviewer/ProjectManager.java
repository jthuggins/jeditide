...
public final class ProjectManager {
	...
	private final static String PRJ_ICON		= "icon";
	...
	private void writeProject(Entry e, Writer out) throws IOException {
		...
		if (e.project.getIconPath() != null) {
			writeAttr(PRJ_ICON, e.project.getIconPath(), out);
		}
		out.write(" />\n");
	} //}}}
	...
	private class PVConfigHandler extends DefaultHandler {
								 ...
								 String qName, Attributes attrs)
		{
 			if (qName.equals(PROJECT_ELEMENT)) {
				...
				e.project.setIconPath(attrs.getValue(PRJ_ICON));
