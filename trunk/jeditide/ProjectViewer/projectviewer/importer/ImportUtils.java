...
public final class ImportUtils
{
	...
	private static final String FILTER_CFG_ADD_HIDDEN	= ".addhidden";
	...
	public static void saveFilter(Properties p,
								  ...
								  String propRoot)
	{
		saveFilter(p, filter, false, propRoot);
	}
	 ...
	 * @param	p			Properties object.
	 * @param	filter		The filter instance.
	 * @param	addHidden	The "add hidden files" option.
	 * @param	propRoot	Root of the configuration property names.
	 *
	 * @since PV 3.0.1
	 */
								  ...
								  String propRoot)
	{
		...
		/*
		 * The "add hidden" property is false by default, so only write
		 * it if it's true.
		 */
		if (addHidden) {
			p.setProperty(propRoot + FILTER_CFG_ADD_HIDDEN, "true");
		} else {
			p.remove(propRoot + FILTER_CFG_ADD_HIDDEN);
		}
	}
	 ...
	 *
	 * @return Whether the "add hidden files" option is set.
	 *
	 * @since PV 3.0.1
	 */
	public static boolean getAddHiddenFiles(Properties p,
											String propRoot)
	{
		String val = p.getProperty(propRoot + FILTER_CFG_ADD_HIDDEN);
